    ...
    else
    {
        ...
        if(flag==0)
        {
                        ...
                        //var myobjSerilized=JSON.stringify(myobj);
                                ...
                                axios.post("https://crudcrud.com/api/273aa0993df84df98323077f0b95b2f6/appioment",myobj)
                                .then((Response) =>{
...
function showNewUserOnScreen(){
    ...
    axios.get("https://crudcrud.com/api/273aa0993df84df98323077f0b95b2f6/appioment")
                        .then((Response) =>{
    ...
    .then((Response) =>{
        for(var i=0;i<Response.data.length;i++)
        {
           ...
           if( Response.data[i].email===emailId)
           {
             ...
             axios.delete(`https://crudcrud.com/api/273aa0993df84df98323077f0b95b2f6/appioment/${serId}`)
             .then((Response) =>{
                 console.log(Response)
                 showNewUserOnScreen();
             }).catch( (err)=>{console.log(err)});
